      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card">
          ...
          <div className="space-y-3">
            {stats?.byStatus && Object.entries(stats.byStatus).map(([key, value]) => (
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-32 h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${(value / (stats?.totalTickets || 1)) * 100}%` }}
                    />
                  </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {stats?.byPriority && Object.entries(stats.byPriority).map(([key, value]) => {
